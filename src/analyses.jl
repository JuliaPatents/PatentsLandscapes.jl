...
"""
    prepdata(ds::AbstractDataSource, type::Analysis, level::AnalysisLevel, [filter::AbstractFilter], [g1::Grouping], [g2::Grouping], [g3::Grouping])::DataFrame
...
* `level`: The `AnalysisLevel` for the analysis, e.g. `Applications()`, `Families()` etc.
